...
from Employees as e
 left join Departments as d on e.DepartmentID=e.DepartmentID
...
from Products as p left join Suppliers as s on p.ProductID=s.SupplierID
...
select*from Employees
select e.Name,m.ManagerID 
from Employees as e
join Employees as m on e.EmployeeID=e.EmployeeID
...
select s.Name,e.CourseID,c.CourseName
from Students as s
