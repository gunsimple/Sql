...
SELECT 
  ...
  Quantity,
  CASE 
    WHEN Quantity = 1 THEN 0.03       -- если ровно 1 товар → 3%
    WHEN Quantity BETWEEN 2 AND 3 THEN 0.05  -- от 2 до 3 товаров → 5%
    ELSE 0.07                         -- всё остальное → 7%
